        ...
        <div class="container-xxl py-5">
            ...
            <div class="container py-5 px-lg-5">
                ...
                <div class="row g-5 align-items-center">
                    <img class="registration-image" src="img/about.png">
                    <div class="col-lg-6">
                        ...
                        <form method="post" action="adminhome">
                           <div class="table-container" > 
                            <table >
                                ...
                                <tr align=center >
                                   <a href="adminhome.jsp"><td colspan=2><input type="submit" value="login" class="button" ></td></a>
                                    </tr>
